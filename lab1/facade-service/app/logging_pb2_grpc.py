...
import logging_pb2 as proto_dot_logging__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in proto/logging_pb2_grpc.py depends on'
...
class LoggingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAllMessages = channel.unary_unary(
                '/logging.LoggingService/GetAllMessages',
                request_serializer=proto_dot_logging__pb2.Empty.SerializeToString,
                response_deserializer=proto_dot_logging__pb2.MessagesResponse.FromString,
                _registered_method=True)
...
def add_LoggingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAllMessages': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto_dot_logging__pb2.Empty.FromString,
                    response_serializer=proto_dot_logging__pb2.MessagesResponse.SerializeToString,
            ),
    }
...
class LoggingService(object):
    ...
    def LogMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/logging.LoggingService/LogMessage',
            proto_dot_logging__pb2.LogRequest.SerializeToString,
            proto_dot_logging__pb2.LogResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetAllMessages(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/logging.LoggingService/GetAllMessages',
            proto_dot_logging__pb2.Empty.SerializeToString,
            proto_dot_logging__pb2.MessagesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
