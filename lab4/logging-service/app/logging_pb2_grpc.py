...
class LoggingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAllMessages = channel.unary_unary(
                '/LoggingService/GetAllMessages',
                request_serializer=logging__pb2.GetAllMessagesRequest.SerializeToString,
                response_deserializer=logging__pb2.MessagesResponse.FromString,
                _registered_method=True)
...
def add_LoggingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAllMessages': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=logging__pb2.GetAllMessagesRequest.FromString,
                    response_serializer=logging__pb2.MessagesResponse.SerializeToString,
            ),
    }
...
class LoggingService(object):
    ...
    def GetAllMessages(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/LoggingService/GetAllMessages',
            logging__pb2.GetAllMessagesRequest.SerializeToString,
            logging__pb2.MessagesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
